...
const THEME_OPTIONS: ReadonlyArray<{
  ...
  {
    id: 'anansmart',
    label: 'OE3IDE AnanSmart',
    blurb: 'Cool silver-gray ANAN transceiver chassis with electric blue readouts.',
    swatch: '#6C6B6C',
  },
  {
    id: 'xmas',
    label: 'OE3IDE XMAS',
    blurb: 'Festive dark crimson chassis with holly green buttons and warm Christmas accents.',
    swatch: '#48120A',
  },
  {
    id: 'highvisual',
    label: 'W1AEX High Visual',
    blurb: 'Maximum-contrast high-visibility ergonomic operator skin with bold color coding.',
    swatch: '#111111',
  },
  {
    id: 'ik3vig',
    label: 'IK3VIG Special',
    blurb: 'Cool slate-gray chassis with a polished operator-focused Italian blue layout.',
    swatch: '#515151',
  },
  {
    id: 'n2mdxhl2',
    label: 'N2MDX HL2 Ultra',
    blurb: 'Navy blue Hermes Lite 2 chassis with ultra-high-resolution display styling.',
    swatch: '#182F5F',
  },
  {
    id: 'n2mdxmics',
    label: 'N2MDX MICS 01',
    blurb: 'Dark technical studio-gray SDR with precision mic-input station design.',
    swatch: '#454548',
  },
  {
    id: 'rz1zr',
    label: 'RZ1ZR',
    blurb: 'Near-black tactical chassis with electric indigo control accent.',
    swatch: '#22262C',
  },
  {
    id: 'alienpred',
    label: 'N2MDX AlienPred',
    blurb: 'Dark jungle military chassis themed after Alien vs. Predator.',
    swatch: '#22272B',
  },
  {
    id: 'apache',
    label: 'N2MDX Apache',
    blurb: 'Near-black tactical military helicopter cockpit operator skin.',
    swatch: '#141416',
  },
  {
    id: 'circuit',
    label: 'N2MDX Circuit',
    blurb: 'Green circuit board PCB trace texture on muted teal chassis.',
    swatch: '#3D5249',
  },
  {
    id: 'joker',
    label: 'N2MDX Joker',
    blurb: 'Dark crimson-purple Joker chaos themed console with amber accents.',
    swatch: '#403335',
  },
  {
    id: 'kiss',
    label: 'N2MDX KISS',
    blurb: 'Pure jet-black KISS rock band console with fiery red devil accents.',
    swatch: '#0A0A0A',
  },
  {
    id: 'kiss2',
    label: 'N2MDX KISS 2',
    blurb: 'KISS band variant two — near-black stage aesthetic with bold red emphasis.',
    swatch: '#161616',
  },
  {
    id: 'ledzep',
    label: 'N2MDX Led Zeppelin',
    blurb: 'Dark grayscale rock console inspired by the Led Zeppelin album covers.',
    swatch: '#2E2E2E',
  },
  {
    id: 'maiden',
    label: 'N2MDX Iron Maiden',
    blurb: 'Dark brown-black Iron Maiden console with fierce orange-flame accents.',
    swatch: '#4D4138',
  },
  {
    id: 'metallica',
    label: 'N2MDX Metallica',
    blurb: 'Brutal near-black Metallica console with cold metallic silver labelling.',
    swatch: '#252525',
  },
  {
    id: 'nascar',
    label: 'N2MDX NASCAR',
    blurb: 'Warm golden-olive NASCAR racing chassis with championship yellow accents.',
    swatch: '#3D3820',
  },
  {
    id: 'riddler',
    label: 'N2MDX Riddler',
    blurb: 'Deep dark green Riddler villain console with neon question-mark accents.',
    swatch: '#02200D',
  },
  {
    id: 'n2mdxst',
    label: 'N2MDX StarTrek',
    blurb: 'Dark LCARS starship console in the N2MDX Star Trek style.',
    swatch: '#2F282D',
  },
  {
    id: 'starwars',
    label: 'N2MDX Star Wars',
    blurb: 'Galactic Empire near-black space console with Republic blue highlights.',
    swatch: '#050608',
  },
  {
    id: 'terminator',
    label: 'N2MDX Terminator',
    blurb: 'Cyberdyne dark chassis with Terminator red targeting laser accents.',
    swatch: '#0C0D1B',
  },
  {
    id: 'tron',
    label: 'N2MDX Tron',
    blurb: 'Dark teal Tron Grid console with neon electric cyan light-cycle traces.',
    swatch: '#1E3638',
  },
  {
    id: 'warriors',
    label: 'N2MDX Warriors',
    blurb: 'Warm tan street-gang Warriors console with gritty NYC orange accents.',
    swatch: '#5A4A35',
  },
  {
    id: 'worldmaps',
    label: 'N2MDX World Maps',
    blurb: 'Deep space 3D globe atlas render with ocean blue accents.',
    swatch: '#050810',
  },
];
